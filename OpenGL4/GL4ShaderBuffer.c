...
crShaderBufferHandle crGL4CreateShaderBuffer(const struct crShaderBufferDescriptor Descriptor)
	{
	struct crGL4InternalShaderBufferInfo *NewShaderBuffer = calloc(1, sizeof(struct crGL4InternalShaderBufferInfo));
