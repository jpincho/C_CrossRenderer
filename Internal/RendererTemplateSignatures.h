...
// Framebuffer
DECLARE_INTERFACE_FUNCTION ( crFramebufferHandle, CreateFramebuffer, const struct crFramebufferDescriptor Descriptor );
...
// Shader
DECLARE_INTERFACE_FUNCTION ( crShaderHandle, CreateShader, struct crShaderCode NewCode );
DECLARE_INTERFACE_FUNCTION ( bool, DeleteShader, const crShaderHandle Handle );
DECLARE_INTERFACE_FUNCTION ( const struct crShaderInformation *, GetShaderInformation, const crShaderHandle Handle );

// Shader Buffer
DECLARE_INTERFACE_FUNCTION ( crShaderBufferHandle, CreateShaderBuffer, const struct crShaderBufferDescriptor CreationParameters );
...
DECLARE_INTERFACE_FUNCTION ( void *, MapShaderBuffer, const crShaderBufferHandle Handle, const enum crShaderBufferMapAccessType AccessType );
DECLARE_INTERFACE_FUNCTION ( bool, UnmapShaderBuffer, const crShaderBufferHandle Handle );

// Texture
DECLARE_INTERFACE_FUNCTION ( crTextureHandle, CreateTexture, const struct crTextureDescriptor Descriptor );
DECLARE_INTERFACE_FUNCTION ( bool, DeleteTexture, const crTextureHandle Handle );
DECLARE_INTERFACE_FUNCTION ( bool, Load2DTextureData, const crTextureHandle Handle, const enum crPixelFormat SourcePixelFormat, const void *data );
DECLARE_INTERFACE_FUNCTION ( bool, Update2DTextureRegion, const crTextureHandle Handle, const uvec2 LowerLeft, const uvec2 RegionDimensions, const enum crPixelFormat SourcePixelFormat, const void *Data );
DECLARE_INTERFACE_FUNCTION ( bool, LoadCubeMapTextureData, const crTextureHandle Handle, const enum crPixelFormat SourcePixelFormat, void *Data[6] );
DECLARE_INTERFACE_FUNCTION ( void, GetTextureDimensions, const crTextureHandle Handle, uvec2 *Dimensions );
DECLARE_INTERFACE_FUNCTION ( enum crPixelFormat, GetTextureFormat, const crTextureHandle Handle );

// Renderer
DECLARE_INTERFACE_FUNCTION ( bool, InitializeRenderer, const struct crRendererConfiguration NewConfiguration );
...
DECLARE_INTERFACE_FUNCTION ( bool, RunCommand, const struct crRenderCommand Command );
